          ...
          <form action="" method="post" id="createJobForm" name="createJobForm">
            <div class="card border-0 shadow mb-4">
              <div class="card-body card-form p-4">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <label for="" class="mb-3 fs-5 fst-italic">Thời gian làm việc<span
                ...
                <div class="row">
                  ...
                  <div class="mb-4 col-md-6">
                    <label for="" class="mb-3 fs-5 fst-italic">Vị trí cần tuyển<span
                        class="req">*</span></label>
                    <input type="text" placeholder="Ví dụ: Junior, Middle, Senior,..." id="level" name="level"
                      class="form-control" value="{{ old('level') }}">
                    <p></p>
                  </div>
                </div>
                ...
                <div class="mb-4">
                  ...
                  <textarea class="textarea" name="responsibility" id="responsibility" cols="5" rows="5"
                    placeholder="Trách nhiệm">{{ old('responsibility') }}</textarea>
                </div>
                <div class="mb-4">
                  ...
                  <textarea class="textarea" name="qualifications" id="qualifications" cols="5" rows="5"
                    placeholder="Nhập yêu cầu công việc...">{{ old('qualifications') }}</textarea>
                </div>
                ...
                <div class="row">
                  <div class="mb-4">
                    ...
                    <input type="text" placeholder="Ví dụ: TopWork" id="company_name" name="company_name"
                  ...
                  <div class="mb-4">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="hidden" id="district_name" name="district_name"
                        value="{{ old('district_name', $user->district) }}">
                      ...
                      <input type="hidden" id="ward_name" name="ward_name"
                        value="{{ old('ward_name', $user->wards) }}">
                    </div>
