    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                        ...
                        <div class="card-body  p-4">
                                ...
                                <div class="mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <select class="form-select" id="province" name="province">
                                                <?php if(!empty($user->province)): ?>
                                                    <option selected><?php echo e($user->province); ?></option>
                                                <?php else: ?>
                                            ...
                                            <select class="form-select" id="district" name="district">
                                                <?php if(!empty($user->district)): ?>
                                                    <option selected><?php echo e($user->district); ?></option>
                                                <?php else: ?>
                                            ...
                                            <select class="form-select" id="wards" name="wards">
                                                <?php if(!empty($user->wards)): ?>
                                                    <option selected><?php echo e($user->wards); ?></option>
                                                <?php else: ?>
                                    ...
                                    <input type="text" 
                                        ...
                                        value="<?php echo e($user->location_detail); ?>"
                                        >
                                </div>
                                ...
                                <div class="mb-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" 
                                            ...
                                            class="form-control"
                                            value="<?php echo e($user->company_website); ?>"
                                            >
                                    </div>
                                </div>   
                ...
                <?php if(Auth::check() && Auth::user()->password !== null && Auth::user()->password !== ''): ?>
                    <div class="card border-0 shadow mb-4">
...
<script type="text/javascript">
    ...
    $("#userFormCompany").submit(function(e){
        ...
        $.ajax({
            url: '<?php echo e(route("account.updateProfileCompany")); ?>',
            type: 'put',
            dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Learning\N4_HK1_2024_2025\Do_an_3\project_3\resources\views/front/account/profile.blade.php ENDPATH**/ ?>