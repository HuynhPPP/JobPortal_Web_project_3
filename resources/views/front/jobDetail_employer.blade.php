                                    ...
                                    @if ($applications->isNotEmpty())
                                        @foreach ($applications as $application)
                                            <tr>
                                                ...
                                                <div class="modal fade" id="processApplicationModal{{ $application->id }}" tabindex="-1" aria-labelledby="processApplicationModalLabel{{ $application->id }}" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="processApplicationModalLabel{{ $application->id }}">Phê duyệt và Gửi thông báo</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form action="{{ route('process.application', ['id' => $application->id]) }}" method="POST">
                                                                    @csrf
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="6" ><p class="text-danger">Chưa có ứng viên</p></td>
                                            </tr>
                                    @endif
                                </table>
                            </div>
