    ...
    <div class="container py-5">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <form action="" method="post" id="userForm" name="userForm">
              <div class="card-body  p-4">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" name="name" id="name" placeholder="Ví dụ: Nguyễn Văn A"
                    class="form-control" value="{{ $user->fullname }}">
                  <p></p>
                </div>
                <div class="mb-4">
                  @if (Auth::check() && Auth::user()->role === 'employer')
                    <label for="" class="mb-3 fs-5">Email <span style="color: red">*</span> (vui lòng sử dụng
                      email công ty)</label>
                  @else
                    <label for="" class="mb-3 fs-5">Email <span style="color: red">*</span></label>
                  @endif
                  <input type="text" name="email" id="email" placeholder="Ví dụ: hr@topwork.vn"
                ...
                <div class="mb-4">
                  ...
                  <input type="text" name="mobile" id="mobile" placeholder="Ví dụ: 0912345678" class="form-control"
                    value="{{ $user->mobile }}">
                  <p></p>
                </div>
              </div>
              ...
              <form action="" method="post" id="userFormCompany" name="userFormCompany">
                <div class="card-body  p-4">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" name="company_name" id="company_name" placeholder="Ví dụ: TopWork"
                  ...
                  <div class="mb-4">
                    <div class="mb-4">
                      ...
                      <input type="text" placeholder="Ví dụ: https://topwork.vn/" id="company_website"
                        name="company_website" class="form-control" value="{{ $user->company_website }}">
                    </div>
                  </div>
          ...
          @if (Auth::check() && Auth::user()->password !== null && Auth::user()->password !== '')
            <div class="card border-0 shadow mb-4">
              <form action="" method="POST" id="changePasswordForm" name="changePasswordForm">
                <div class="card-body p-4">
                  <h3 class="fs-4 mb-1">Thay đổi mật khẩu</h3>
                  <p class="fs-5 fst-italic">Lưu ý: các trường chứa dấu <span style="color: red">*</span> là bắt buộc
                  </p>
                  <div class="mb-4">
