          ...
          <div class="card shadow border-0 p-5">
            ...
            <form action="{{ route('account.processResetPassword') }}" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="password" name="new_password" id="new_password" value="{{ old('email') }}"
                  class="form-control  @error('new_password') is-invalid @enderror" placeholder="Nhập mật khẩu mới">
              ...
              <div class="mb-3">
                ...
                <input type="password" name="confirm_password" id="confirm_password" value="{{ old('email') }}"
                  class="form-control  @error('confirm_password') is-invalid @enderror" placeholder="Nhập mật khẩu mới">
